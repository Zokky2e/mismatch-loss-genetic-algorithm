...
from extractingParameters import extraction, plotPanel, plotPanelGroup
from firstConfiguration import *
from importSolarPanels import importPanels
from exportSolarPanels import exportPanels
from geneticAlgorithm import doAlgorithm, fitness
from sharedMethods import *
from mismatchCalculations import group_panels
import numpy as np
...
def main():    
    ...
    generations = 5000              # Number of generations the algorithm will run
